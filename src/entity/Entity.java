...
public class Entity {
    ...
    public void use(Entity entity) {
        // EMPTY BECAUSE OVER WRITING IT IN OTHER CLASSES
    }
    ...
    public void draw(Graphics2D g2) {
        ...
        if (worldX + gp.tileSize > gp.player.worldX - gp.player.screenX &&
            ...
            if (type == 2 && hpBarOn == true) {
                ...
                g2.fillRoundRect(screenX - 1, screenY - 15, gp.tileSize, 10, 2, 2);

                g2.setColor(new Color(255, 0, 30));
                g2.fillRoundRect(screenX, screenY - 15, (int) hpBarValue, 10, 2, 2);
